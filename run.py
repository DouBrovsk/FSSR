...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_folder', default='./DataMemopainter/meta/source/train', help="Path to the folder containing the images of the training set. Only for 'train' mode.")
    parser.add_argument('--valid_folder', default='./DataMemopainter/meta/source/test', help="Path to the folder containing the images of the validation set. Only for 'train' mode.")
